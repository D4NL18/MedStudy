...
/**
 * Enumeration representing the different types of badges a user can earn.
 */
...
public enum BadgeType {
    ...
    /**
     * Constructs a BadgeType with a display name and description.
     *
     * @param displayName the display name of the badge
    ...
    /**
     * Gets the system name of the badge.
     *
