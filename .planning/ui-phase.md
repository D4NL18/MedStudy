...
```markdown
Read ~/.gemini/antigravity/agents/gsd-ui-researcher.md for instructions.
...
Template: ~/.gemini/antigravity/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read ~/.gemini/antigravity/agents/gsd-ui-checker.md for instructions.
