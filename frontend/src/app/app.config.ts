...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(LucideAngularModule.pick({ 
      ...
      Users, UserPlus, UserMinus, UserCheck, UserX, Ban
    })),
    provideStore({ 
      theme: themeReducer,
      auth: authReducer,
