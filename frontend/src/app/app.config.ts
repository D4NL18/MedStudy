...
import { LucideAngularModule, Diamond, ChevronRight, CheckCircle, Calendar, Clock, Play, AlertCircle, X, RotateCw, Check, AlertTriangle, Plus, Search, Filter, Edit, Edit2, Trash2, Circle, TrendingUp, TrendingDown, Maximize2, Info, FileSpreadsheet, FileText, RefreshCcw, Zap, Target, Award, Bell, BookOpen, Lock } from 'lucide-angular';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(LucideAngularModule.pick({ 
      ...
      Plus, Search, Filter, Edit, Edit2, Trash2, Circle, TrendingUp, TrendingDown, Maximize2, Info, FileSpreadsheet, FileText, RefreshCcw,
      Zap, Target, Award, Bell, BookOpen, Lock
    })),
    provideStore({ 
      theme: themeReducer,
      auth: authReducer,
